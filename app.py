...
# Dummy Gradio UI (for Hugging Face Spaces compatibility)
with gr.Blocks() as demo:
    gr.Markdown("# ContractLens API Server")
    gr.Markdown("Your main application is running at the root **[/](/)**.")
    gr.Markdown("If you are accessing this on Hugging Face, click the link above to view the main UI.")

# Mount Gradio app on FastAPI
app = gr.mount_gradio_app(app, demo, path="/gradio")

# Serve frontend static files (Must be mounted AFTER Gradio to ensure routes don't conflict)
